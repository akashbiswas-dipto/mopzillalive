        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/mopzilla/public/views/team_dashboard/clientlist.php">Client List</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/mopzilla/public/views/team_dashboard/teamlist.php">Team List</a>
                    </li>
                    <?php endif; ?>
                    <li class="nav-item">
