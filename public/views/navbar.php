    ...
    <nav class="navbar navbar-expand-lg">
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-center" id="navbarNav">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link active" aria-current="page" href="/mopzilla/index">Home</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="/mopzilla/public/views/aboutus">About Us</a>
                    </li>
                ...
                <ul class="navbar-nav">
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
                            <a class="nav-link" href="/mopzilla/public/views/login">Login/Sign Up</a>
                        </li>
                </ul>
            </div>
        </div>
