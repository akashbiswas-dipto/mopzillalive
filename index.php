<?php include_once('public/views/navbar.php');?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <link rel="stylesheet" type="text/css" href="/mopzilla/public/css/index.css">
...
<body>
    ...
    <div class="whychoseus">
        <h1><img src="/mopzilla/public/content/logo.png" alt="mopzilla logo" width="100px">WHY <span style="color:#234f1E; ">CHOSE US?</span></h1>
        <div class="content">
            <div class="reason">   
                <img src="/mopzilla/public/content/broom.png" alt="cleaning image">
            ...
            <div class="reason">  
                <img src="/mopzilla/public/content/recycle.png" alt="recycle image">
            ...
            <div class="reason">
                <img src="/mopzilla/public/content/clock.png" alt="clock image">
            ...
            <div class="reason">
                <img src="/mopzilla/public/content/dollar-sign.png" alt="dollar-sign image">
            ...
            <div class="reason">
                <img src="/mopzilla/public/content/green-love.png" alt="love image">
